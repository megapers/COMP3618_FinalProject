using SearchToolbox.REST.Client;
using System;

namespace SearchToolbox.RESTClientTesting
{
    class Program
    {
        private static readonly RESTClient _restClient = new RESTClient(new Uri("http://localhost:54754"));
        ...
        private static void TestGetSearchMatches(string searchFor)
        {
            ...
            Console.WriteLine($"Matches: { _restClient.GetSearchMatches(searchFor):N0}");
        }
